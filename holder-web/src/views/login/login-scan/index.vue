...
import { defineAsyncComponent, reactive, watchEffect, ref } from 'vue'
...
const state = reactive({
    rules: {},
    ruleForm: {
        name: 'priSPKtUdtndJea11yfQfT4zLqLGUij7NNTMfMUaB5t2Pv3c91'
    },
    privateKeyArr: [
        {
            privateKey: 'priSPKtUdtndJea11yfQfT4zLqLGUij7NNTMfMUaB5t2Pv3c91',
            bid: 'did:bid:efnLDXexDs1TsSZdtRmrrKHW3kFvoyFN',
            publicKey:
                'b0656634b26ad99aad0aed020095187e26ecef8b8dbf607ab981ddbfa337b6ef90a1f1'
        }
    ],
    isShowSvg: true,
    qrCodeUrl: '' // 二维码的内容
...
<template>
    <div class="contain">
        <div class="contain-content">
            <div class="contain-content-left"></div>
            <div class="contain-content-right">
                <div class="contain-content-right-content">
                    ...
                    <p class="contain-content-right-con">
                        some information from your privateKey.
                    </p>
                    ...
                    <div style="margin-top: 40px">
                        <button
                            class="contain-content-right_btn"
                            @click="loginFormLink()"
                        >
                            login
                        </button>
                    ...
                    <div class="contain-content-right_bot">
                        <p class="contain-content-right_bot_text">
                            Enter the private key to log in
                        </p>
                        <p class="contain-content-right_bot_text">
                            provide your privateKey.
                        </p>
                    </div>
                </div>
            </div>
