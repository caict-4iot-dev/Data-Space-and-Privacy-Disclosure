    ...
    <div class="policy">
      <div style="display: flex;margin-left: 100px">
        ...
        <el-table :data="state.tableData" height="550" style="width: 100%">
            ...
            <el-table-column label="Credential Type" prop="type" width="220" />
            <el-table-column label="Application Date" prop="issuanceDate" width="220" />
...
const getTableData = async ()=>{
    ...
    res.data.forEach((item)=>{
        // if(item.status !==1){
            ...
            item.type = 'Zero-Knowledge Proofs';
