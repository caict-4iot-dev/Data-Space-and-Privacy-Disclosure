...
const getImgClass = computed(() => {
  return props?.imgClass
})

// 设置图片样式
const setIconImgOutStyle = computed(() => {
  return `width: ${props.size}px;height: ${props.size}px;position:relative;display: inline-block;overflow: hidden;`
})
// 设置图片样式
const setIconSvgInsStyle = computed(() => {
  ...
  return `width: ${props.size}px;height: ${
    props.size
  }px;position:absolute;top:0;left: 0px;${filterStyle.join('')}`
})
</script>
