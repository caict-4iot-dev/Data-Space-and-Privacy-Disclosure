 ...
 * @param data
 */
export function updateCertificateRecordApi(data: Object) {
    return request({
        url: `updatecredentialList`,
        method: 'post',
        data
    })
}
 ...
 * @param data
 */
export function applyRedential(data: Object) {
    return request({
        url: `applyRedential`,
        method: 'post',
        data
 ...
 * @param data
 */
export function verupdatecredentialList(data: Object) {
    return request({
        url: `verupdatecredentialList`,
        method: 'post',
        data
    })
}
 ...
 * @param data
 */
export function vergetcredentialList(data: Object) {
    return request({
        url: `vergetcredentialList`,
        method: 'post',
        data
    })
}
